...
export type RepsProgressSectionDtoPrescriptionType = typeof RepsProgressSectionDtoPrescriptionType[keyof typeof RepsProgressSectionDtoPrescriptionType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const RepsProgressSectionDtoPrescriptionType = {
  REPS: 'REPS',
  DURATION: 'DURATION',
} as const;
