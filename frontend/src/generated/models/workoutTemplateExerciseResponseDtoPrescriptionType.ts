...
export type WorkoutTemplateExerciseResponseDtoPrescriptionType = typeof WorkoutTemplateExerciseResponseDtoPrescriptionType[keyof typeof WorkoutTemplateExerciseResponseDtoPrescriptionType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const WorkoutTemplateExerciseResponseDtoPrescriptionType = {
  REPS: 'REPS',
  DURATION: 'DURATION',
} as const;
