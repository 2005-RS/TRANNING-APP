...
export type ClientProgressListExercisesPrescriptionType = typeof ClientProgressListExercisesPrescriptionType[keyof typeof ClientProgressListExercisesPrescriptionType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ClientProgressListExercisesPrescriptionType = {
  REPS: 'REPS',
  DURATION: 'DURATION',
} as const;
