...
export type ClientNutritionPlansListMineSort = typeof ClientNutritionPlansListMineSort[keyof typeof ClientNutritionPlansListMineSort];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ClientNutritionPlansListMineSort = {
  name: 'name',
  createdAt: 'createdAt',
  updatedAt: 'updatedAt',
  startDate: 'startDate',
