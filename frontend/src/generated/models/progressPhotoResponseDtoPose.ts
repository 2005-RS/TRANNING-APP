...
export type ProgressPhotoResponseDtoPose = typeof ProgressPhotoResponseDtoPose[keyof typeof ProgressPhotoResponseDtoPose];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ProgressPhotoResponseDtoPose = {
  FRONT: 'FRONT',
  SIDE: 'SIDE',
  BACK: 'BACK',
  OTHER: 'OTHER',
