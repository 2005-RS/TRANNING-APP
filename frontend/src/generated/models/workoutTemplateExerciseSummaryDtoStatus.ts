...
export type WorkoutTemplateExerciseSummaryDtoStatus = typeof WorkoutTemplateExerciseSummaryDtoStatus[keyof typeof WorkoutTemplateExerciseSummaryDtoStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const WorkoutTemplateExerciseSummaryDtoStatus = {
  ACTIVE: 'ACTIVE',
  ARCHIVED: 'ARCHIVED',
} as const;
