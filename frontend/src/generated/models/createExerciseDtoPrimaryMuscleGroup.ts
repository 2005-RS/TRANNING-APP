...
export type CreateExerciseDtoPrimaryMuscleGroup = typeof CreateExerciseDtoPrimaryMuscleGroup[keyof typeof CreateExerciseDtoPrimaryMuscleGroup];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const CreateExerciseDtoPrimaryMuscleGroup = {
  CHEST: 'CHEST',
  BACK: 'BACK',
  SHOULDERS: 'SHOULDERS',
  BICEPS: 'BICEPS',
