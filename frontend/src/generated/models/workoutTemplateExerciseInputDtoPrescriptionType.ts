...
export type WorkoutTemplateExerciseInputDtoPrescriptionType = typeof WorkoutTemplateExerciseInputDtoPrescriptionType[keyof typeof WorkoutTemplateExerciseInputDtoPrescriptionType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const WorkoutTemplateExerciseInputDtoPrescriptionType = {
  REPS: 'REPS',
  DURATION: 'DURATION',
} as const;
