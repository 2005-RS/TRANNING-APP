...
export type NutritionPlanResponseDtoStatus = typeof NutritionPlanResponseDtoStatus[keyof typeof NutritionPlanResponseDtoStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const NutritionPlanResponseDtoStatus = {
  DRAFT: 'DRAFT',
  ACTIVE: 'ACTIVE',
  ARCHIVED: 'ARCHIVED',
} as const;
