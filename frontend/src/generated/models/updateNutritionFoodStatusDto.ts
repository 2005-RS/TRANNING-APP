 ...
 */
import type { UpdateNutritionFoodStatusDtoStatus } from './updateNutritionFoodStatusDtoStatus';

export interface UpdateNutritionFoodStatusDto {
  /** ACTIVE foods are shared catalog entries. ARCHIVED foods remain stored. There is no DELETE. */
  status: UpdateNutritionFoodStatusDtoStatus;
}
