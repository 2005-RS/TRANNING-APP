...
export type ProgressListExercisesDirection = typeof ProgressListExercisesDirection[keyof typeof ProgressListExercisesDirection];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ProgressListExercisesDirection = {
  ASC: 'ASC',
  DESC: 'DESC',
} as const;
