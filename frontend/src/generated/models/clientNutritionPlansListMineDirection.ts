...
export type ClientNutritionPlansListMineDirection = typeof ClientNutritionPlansListMineDirection[keyof typeof ClientNutritionPlansListMineDirection];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ClientNutritionPlansListMineDirection = {
  ASC: 'ASC',
  DESC: 'DESC',
} as const;
