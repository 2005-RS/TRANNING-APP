...
export type TrainingPlanSummaryResponseDtoStatus = typeof TrainingPlanSummaryResponseDtoStatus[keyof typeof TrainingPlanSummaryResponseDtoStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const TrainingPlanSummaryResponseDtoStatus = {
  DRAFT: 'DRAFT',
  ACTIVE: 'ACTIVE',
  ARCHIVED: 'ARCHIVED',
} as const;
