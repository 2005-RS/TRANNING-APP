...
export type NutritionFoodsListDirection = typeof NutritionFoodsListDirection[keyof typeof NutritionFoodsListDirection];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const NutritionFoodsListDirection = {
  ASC: 'ASC',
  DESC: 'DESC',
} as const;
