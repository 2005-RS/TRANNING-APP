...
export type NutritionPlanSummaryResponseDtoStatus = typeof NutritionPlanSummaryResponseDtoStatus[keyof typeof NutritionPlanSummaryResponseDtoStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const NutritionPlanSummaryResponseDtoStatus = {
  DRAFT: 'DRAFT',
  ACTIVE: 'ACTIVE',
  ARCHIVED: 'ARCHIVED',
} as const;
