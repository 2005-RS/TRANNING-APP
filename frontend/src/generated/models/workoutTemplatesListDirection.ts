...
export type WorkoutTemplatesListDirection = typeof WorkoutTemplatesListDirection[keyof typeof WorkoutTemplatesListDirection];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const WorkoutTemplatesListDirection = {
  ASC: 'ASC',
  DESC: 'DESC',
} as const;
