...
export type ExercisesListPrimaryMuscleGroup = typeof ExercisesListPrimaryMuscleGroup[keyof typeof ExercisesListPrimaryMuscleGroup];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ExercisesListPrimaryMuscleGroup = {
  CHEST: 'CHEST',
  BACK: 'BACK',
  SHOULDERS: 'SHOULDERS',
  BICEPS: 'BICEPS',
