 ...
 */
import type { UpdateCheckInReviewDtoActionItems } from './updateCheckInReviewDtoActionItems';

export interface UpdateCheckInReviewDto {
  /**
   ...
   * @nullable
   */
  actionItems?: UpdateCheckInReviewDtoActionItems;
}
