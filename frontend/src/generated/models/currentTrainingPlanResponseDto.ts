 ...
 */
import type { CurrentTrainingPlanResponseDtoTrainingPlan } from './currentTrainingPlanResponseDtoTrainingPlan';

export interface CurrentTrainingPlanResponseDto {
  /** @nullable */
  trainingPlan?: CurrentTrainingPlanResponseDtoTrainingPlan;
}
