...
export type ExerciseProgressDetailResponseDtoExerciseStatus = typeof ExerciseProgressDetailResponseDtoExerciseStatus[keyof typeof ExerciseProgressDetailResponseDtoExerciseStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ExerciseProgressDetailResponseDtoExerciseStatus = {
  ACTIVE: 'ACTIVE',
  ARCHIVED: 'ARCHIVED',
} as const;
