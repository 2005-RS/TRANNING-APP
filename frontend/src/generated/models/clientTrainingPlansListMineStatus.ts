...
export type ClientTrainingPlansListMineStatus = typeof ClientTrainingPlansListMineStatus[keyof typeof ClientTrainingPlansListMineStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ClientTrainingPlansListMineStatus = {
  DRAFT: 'DRAFT',
  ACTIVE: 'ACTIVE',
  ARCHIVED: 'ARCHIVED',
} as const;
