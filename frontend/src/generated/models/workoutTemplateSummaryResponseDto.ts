 ...
 */
import type { WorkoutTemplateSummaryResponseDtoStatus } from './workoutTemplateSummaryResponseDtoStatus';

export interface WorkoutTemplateSummaryResponseDto {
  id: string;
  name: string;
  /** @nullable */
  description?: string | null;
  status: WorkoutTemplateSummaryResponseDtoStatus;
