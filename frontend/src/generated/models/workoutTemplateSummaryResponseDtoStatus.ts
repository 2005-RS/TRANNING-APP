...
export type WorkoutTemplateSummaryResponseDtoStatus = typeof WorkoutTemplateSummaryResponseDtoStatus[keyof typeof WorkoutTemplateSummaryResponseDtoStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const WorkoutTemplateSummaryResponseDtoStatus = {
  DRAFT: 'DRAFT',
  ACTIVE: 'ACTIVE',
  ARCHIVED: 'ARCHIVED',
} as const;
