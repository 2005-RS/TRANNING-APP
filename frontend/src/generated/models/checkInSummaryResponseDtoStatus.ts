...
export type CheckInSummaryResponseDtoStatus = typeof CheckInSummaryResponseDtoStatus[keyof typeof CheckInSummaryResponseDtoStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const CheckInSummaryResponseDtoStatus = {
  DRAFT: 'DRAFT',
  SUBMITTED: 'SUBMITTED',
  REVIEWED: 'REVIEWED',
} as const;
