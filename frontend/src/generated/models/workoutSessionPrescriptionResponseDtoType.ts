...
export type WorkoutSessionPrescriptionResponseDtoType = typeof WorkoutSessionPrescriptionResponseDtoType[keyof typeof WorkoutSessionPrescriptionResponseDtoType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const WorkoutSessionPrescriptionResponseDtoType = {
  REPS: 'REPS',
  DURATION: 'DURATION',
} as const;
