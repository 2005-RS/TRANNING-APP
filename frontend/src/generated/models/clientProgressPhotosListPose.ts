...
export type ClientProgressPhotosListPose = typeof ClientProgressPhotosListPose[keyof typeof ClientProgressPhotosListPose];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ClientProgressPhotosListPose = {
  FRONT: 'FRONT',
  SIDE: 'SIDE',
  BACK: 'BACK',
  OTHER: 'OTHER',
