...
export type WorkoutTemplatesListStatus = typeof WorkoutTemplatesListStatus[keyof typeof WorkoutTemplatesListStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const WorkoutTemplatesListStatus = {
  DRAFT: 'DRAFT',
  ACTIVE: 'ACTIVE',
  ARCHIVED: 'ARCHIVED',
} as const;
