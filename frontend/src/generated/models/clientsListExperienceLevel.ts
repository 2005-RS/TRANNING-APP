...
export type ClientsListExperienceLevel = typeof ClientsListExperienceLevel[keyof typeof ClientsListExperienceLevel];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ClientsListExperienceLevel = {
  BEGINNER: 'BEGINNER',
