...
export type NutritionPlanMealInputDtoMealType = typeof NutritionPlanMealInputDtoMealType[keyof typeof NutritionPlanMealInputDtoMealType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const NutritionPlanMealInputDtoMealType = {
  BREAKFAST: 'BREAKFAST',
  LUNCH: 'LUNCH',
  DINNER: 'DINNER',
  SNACK: 'SNACK',
