 ...
 */
import type { AssignmentHistoryItemDto } from './assignmentHistoryItemDto';
import type { AssignmentHistoryMetaDto } from './assignmentHistoryMetaDto';

export interface PaginatedAssignmentHistoryResponseDto {
