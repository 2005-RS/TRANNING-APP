 ...
 */
import type { TrainerUserResponseDtoRole } from './trainerUserResponseDtoRole';
import type { TrainerUserResponseDtoStatus } from './trainerUserResponseDtoStatus';

export interface TrainerUserResponseDto {
  id: string;
  email: string;
  firstName: string;
  lastName: string;
  role: TrainerUserResponseDtoRole;
  status: TrainerUserResponseDtoStatus;
}
