 ...
 */
import type { UpdateExerciseStatusDtoStatus } from './updateExerciseStatusDtoStatus';

export interface UpdateExerciseStatusDto {
  status: UpdateExerciseStatusDtoStatus;
}
