 ...
 */
import type { UpdateTrainingPlanDtoDescription } from './updateTrainingPlanDtoDescription';
import type { UpdateTrainingPlanDtoStartDate } from './updateTrainingPlanDtoStartDate';
import type { UpdateTrainingPlanDtoEndDate } from './updateTrainingPlanDtoEndDate';
...
export interface UpdateTrainingPlanDto {
   ...
   * @nullable
   */
  description?: UpdateTrainingPlanDtoDescription;
  /** @nullable */
  startDate?: UpdateTrainingPlanDtoStartDate;
  /** @nullable */
  endDate?: UpdateTrainingPlanDtoEndDate;
}
