...
export type UpdateExerciseStatusDtoStatus = typeof UpdateExerciseStatusDtoStatus[keyof typeof UpdateExerciseStatusDtoStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const UpdateExerciseStatusDtoStatus = {
  ACTIVE: 'ACTIVE',
  ARCHIVED: 'ARCHIVED',
} as const;
