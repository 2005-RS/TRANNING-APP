 ...
 */
import type { TrainingPlanExerciseResponseDtoPrescriptionType } from './trainingPlanExerciseResponseDtoPrescriptionType';

export interface TrainingPlanExerciseResponseDto {
  id: string;
  exerciseId: string;
  exerciseName: string;
  position: number;
  sets: number;
  prescriptionType: TrainingPlanExerciseResponseDtoPrescriptionType;
  /** @nullable */
  repsMin?: number | null;
  /** @nullable */
  repsMax?: number | null;
