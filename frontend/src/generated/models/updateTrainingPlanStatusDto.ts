 ...
 */
import type { UpdateTrainingPlanStatusDtoStatus } from './updateTrainingPlanStatusDtoStatus';

export interface UpdateTrainingPlanStatusDto {
  ...
  status: UpdateTrainingPlanStatusDtoStatus;
}
