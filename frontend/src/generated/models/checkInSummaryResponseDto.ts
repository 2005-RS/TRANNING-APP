 ...
 */
import type { CheckInSummaryResponseDtoStatus } from './checkInSummaryResponseDtoStatus';

export interface CheckInSummaryResponseDto {
  id: string;
  periodStart: string;
  periodEnd: string;
  status: CheckInSummaryResponseDtoStatus;
  /** @nullable */
