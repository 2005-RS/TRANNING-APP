...
export type TrainingPlansListDirection = typeof TrainingPlansListDirection[keyof typeof TrainingPlansListDirection];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const TrainingPlansListDirection = {
  ASC: 'ASC',
  DESC: 'DESC',
} as const;
