...
export type NutritionPlansListDirection = typeof NutritionPlansListDirection[keyof typeof NutritionPlansListDirection];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const NutritionPlansListDirection = {
  ASC: 'ASC',
  DESC: 'DESC',
} as const;
