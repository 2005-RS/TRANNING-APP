...
export type ExerciseProgressListItemDtoExerciseStatus = typeof ExerciseProgressListItemDtoExerciseStatus[keyof typeof ExerciseProgressListItemDtoExerciseStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ExerciseProgressListItemDtoExerciseStatus = {
  ACTIVE: 'ACTIVE',
  ARCHIVED: 'ARCHIVED',
} as const;
