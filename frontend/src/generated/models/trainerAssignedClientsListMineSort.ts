...
export type TrainerAssignedClientsListMineSort = typeof TrainerAssignedClientsListMineSort[keyof typeof TrainerAssignedClientsListMineSort];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const TrainerAssignedClientsListMineSort = {
  createdAt: 'createdAt',
  firstName: 'firstName',
  lastName: 'lastName',
  email: 'email',
