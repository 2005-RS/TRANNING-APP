...
export type NutritionFoodResponseDtoStatus = typeof NutritionFoodResponseDtoStatus[keyof typeof NutritionFoodResponseDtoStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const NutritionFoodResponseDtoStatus = {
  ACTIVE: 'ACTIVE',
  ARCHIVED: 'ARCHIVED',
} as const;
