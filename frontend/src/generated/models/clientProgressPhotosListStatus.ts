...
export type ClientProgressPhotosListStatus = typeof ClientProgressPhotosListStatus[keyof typeof ClientProgressPhotosListStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ClientProgressPhotosListStatus = {
