...
export type WorkoutTemplateResponseDtoStatus = typeof WorkoutTemplateResponseDtoStatus[keyof typeof WorkoutTemplateResponseDtoStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const WorkoutTemplateResponseDtoStatus = {
  DRAFT: 'DRAFT',
  ACTIVE: 'ACTIVE',
  ARCHIVED: 'ARCHIVED',
} as const;
