...
export type ClientNutritionPlansListMineStatus = typeof ClientNutritionPlansListMineStatus[keyof typeof ClientNutritionPlansListMineStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ClientNutritionPlansListMineStatus = {
  DRAFT: 'DRAFT',
  ACTIVE: 'ACTIVE',
  ARCHIVED: 'ARCHIVED',
} as const;
