...
export type TrainerUserResponseDtoRole = typeof TrainerUserResponseDtoRole[keyof typeof TrainerUserResponseDtoRole];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const TrainerUserResponseDtoRole = {
  ADMIN: 'ADMIN',
  TRAINER: 'TRAINER',
  CLIENT: 'CLIENT',
} as const;
