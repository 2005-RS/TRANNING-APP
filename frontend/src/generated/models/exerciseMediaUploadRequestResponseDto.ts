 ...
 */
import type { ExerciseMediaResponseDto } from './exerciseMediaResponseDto';
import type { SignedUploadInstructionsDto } from './signedUploadInstructionsDto';

export interface ExerciseMediaUploadRequestResponseDto {
