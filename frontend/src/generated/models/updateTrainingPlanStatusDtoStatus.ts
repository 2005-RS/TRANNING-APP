 ...
 */
export type UpdateTrainingPlanStatusDtoStatus = typeof UpdateTrainingPlanStatusDtoStatus[keyof typeof UpdateTrainingPlanStatusDtoStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const UpdateTrainingPlanStatusDtoStatus = {
  ACTIVE: 'ACTIVE',
  ARCHIVED: 'ARCHIVED',
} as const;
