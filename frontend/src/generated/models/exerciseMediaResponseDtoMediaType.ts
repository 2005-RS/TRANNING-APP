...
export type ExerciseMediaResponseDtoMediaType = typeof ExerciseMediaResponseDtoMediaType[keyof typeof ExerciseMediaResponseDtoMediaType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ExerciseMediaResponseDtoMediaType = {
  VIDEO: 'VIDEO',
  IMAGE: 'IMAGE',
} as const;
