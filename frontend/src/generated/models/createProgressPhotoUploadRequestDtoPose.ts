...
export type CreateProgressPhotoUploadRequestDtoPose = typeof CreateProgressPhotoUploadRequestDtoPose[keyof typeof CreateProgressPhotoUploadRequestDtoPose];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const CreateProgressPhotoUploadRequestDtoPose = {
  FRONT: 'FRONT',
  SIDE: 'SIDE',
  BACK: 'BACK',
  OTHER: 'OTHER',
