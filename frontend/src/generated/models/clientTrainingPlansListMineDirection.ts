...
export type ClientTrainingPlansListMineDirection = typeof ClientTrainingPlansListMineDirection[keyof typeof ClientTrainingPlansListMineDirection];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ClientTrainingPlansListMineDirection = {
  ASC: 'ASC',
  DESC: 'DESC',
} as const;
