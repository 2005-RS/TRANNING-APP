 ...
 */
import type { WorkoutSessionPrescriptionResponseDtoType } from './workoutSessionPrescriptionResponseDtoType';

export interface WorkoutSessionPrescriptionResponseDto {
  sets: number;
  type: WorkoutSessionPrescriptionResponseDtoType;
  /** @nullable */
  repsMin?: number | null;
  /** @nullable */
  repsMax?: number | null;
