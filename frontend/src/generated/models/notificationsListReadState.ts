...
export type NotificationsListReadState = typeof NotificationsListReadState[keyof typeof NotificationsListReadState];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const NotificationsListReadState = {
  ALL: 'ALL',
  UNREAD: 'UNREAD',
  READ: 'READ',
} as const;
