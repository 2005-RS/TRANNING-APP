...
export type TrainerAssignedClientsListMineStatus = typeof TrainerAssignedClientsListMineStatus[keyof typeof TrainerAssignedClientsListMineStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const TrainerAssignedClientsListMineStatus = {
  ACTIVE: 'ACTIVE',
  DISABLED: 'DISABLED',
} as const;
