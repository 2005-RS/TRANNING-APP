...
export type UpdateClientStatusDtoStatus = typeof UpdateClientStatusDtoStatus[keyof typeof UpdateClientStatusDtoStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const UpdateClientStatusDtoStatus = {
  ACTIVE: 'ACTIVE',
  DISABLED: 'DISABLED',
} as const;
