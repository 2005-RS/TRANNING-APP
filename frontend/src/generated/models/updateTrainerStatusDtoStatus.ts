...
export type UpdateTrainerStatusDtoStatus = typeof UpdateTrainerStatusDtoStatus[keyof typeof UpdateTrainerStatusDtoStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const UpdateTrainerStatusDtoStatus = {
  ACTIVE: 'ACTIVE',
  DISABLED: 'DISABLED',
} as const;
