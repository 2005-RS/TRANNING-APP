...
export type ClientDashboardCheckInDtoStatus = typeof ClientDashboardCheckInDtoStatus[keyof typeof ClientDashboardCheckInDtoStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ClientDashboardCheckInDtoStatus = {
  DRAFT: 'DRAFT',
  SUBMITTED: 'SUBMITTED',
  REVIEWED: 'REVIEWED',
} as const;
