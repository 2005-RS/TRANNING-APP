 ...
 */
import type { CheckInResponseDtoStatus } from './checkInResponseDtoStatus';
import type { CheckInResponsesDto } from './checkInResponsesDto';
import type { CheckInResponseDtoReview } from './checkInResponseDtoReview';

export interface CheckInResponseDto {
  id: string;
  periodStart: string;
  periodEnd: string;
  status: CheckInResponseDtoStatus;
  responses: CheckInResponsesDto;
  /** @nullable */
  submittedAt?: string | null;
  /** @nullable */
  review?: CheckInResponseDtoReview;
  createdAt: string;
  updatedAt: string;
}
