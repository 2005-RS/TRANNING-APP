...
export type ClientProgressListExercisesDirection = typeof ClientProgressListExercisesDirection[keyof typeof ClientProgressListExercisesDirection];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ClientProgressListExercisesDirection = {
  ASC: 'ASC',
  DESC: 'DESC',
} as const;
