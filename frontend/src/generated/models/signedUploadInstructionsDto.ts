 ...
 */
import type { SignedUploadInstructionsDtoFields } from './signedUploadInstructionsDtoFields';

export interface SignedUploadInstructionsDto {
  method: string;
  url: string;
  fields: SignedUploadInstructionsDtoFields;
  expiresAt: string;
}
