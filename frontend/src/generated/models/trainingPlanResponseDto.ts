 ...
 */
import type { TrainingPlanResponseDtoStatus } from './trainingPlanResponseDtoStatus';
import type { TrainingPlanWorkoutResponseDto } from './trainingPlanWorkoutResponseDto';
...
export interface TrainingPlanResponseDto {
  ...
  status: TrainingPlanResponseDtoStatus;
  /** @nullable */
