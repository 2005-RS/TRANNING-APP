...
export type ExercisesListEquipmentType = typeof ExercisesListEquipmentType[keyof typeof ExercisesListEquipmentType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ExercisesListEquipmentType = {
