 ...
 */
import type { ProgressPhotoResponseDtoPose } from './progressPhotoResponseDtoPose';
import type { ProgressPhotoResponseDtoStatus } from './progressPhotoResponseDtoStatus';

export interface ProgressPhotoResponseDto {
  id: string;
  pose: ProgressPhotoResponseDtoPose;
  status: ProgressPhotoResponseDtoStatus;
  mimeType: string;
  /** @nullable */
