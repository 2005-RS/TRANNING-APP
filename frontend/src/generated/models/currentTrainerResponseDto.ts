 ...
 */
import type { CurrentTrainerResponseDtoTrainer } from './currentTrainerResponseDtoTrainer';

export interface CurrentTrainerResponseDto {
  /** @nullable */
  trainer?: CurrentTrainerResponseDtoTrainer;
}
