...
export type NutritionPlanMealResponseDtoMealType = typeof NutritionPlanMealResponseDtoMealType[keyof typeof NutritionPlanMealResponseDtoMealType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const NutritionPlanMealResponseDtoMealType = {
  BREAKFAST: 'BREAKFAST',
  LUNCH: 'LUNCH',
  DINNER: 'DINNER',
  SNACK: 'SNACK',
