...
export type ProgressListExercisesPrescriptionType = typeof ProgressListExercisesPrescriptionType[keyof typeof ProgressListExercisesPrescriptionType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ProgressListExercisesPrescriptionType = {
  REPS: 'REPS',
  DURATION: 'DURATION',
} as const;
