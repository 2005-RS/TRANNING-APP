...
export type UpdateTrainingPlanExerciseDtoPrescriptionType = typeof UpdateTrainingPlanExerciseDtoPrescriptionType[keyof typeof UpdateTrainingPlanExerciseDtoPrescriptionType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const UpdateTrainingPlanExerciseDtoPrescriptionType = {
  REPS: 'REPS',
  DURATION: 'DURATION',
} as const;
