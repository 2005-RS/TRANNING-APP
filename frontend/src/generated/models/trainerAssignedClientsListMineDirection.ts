...
export type TrainerAssignedClientsListMineDirection = typeof TrainerAssignedClientsListMineDirection[keyof typeof TrainerAssignedClientsListMineDirection];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const TrainerAssignedClientsListMineDirection = {
  ASC: 'ASC',
  DESC: 'DESC',
} as const;
