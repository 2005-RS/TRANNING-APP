...
export type TrainingPlanResponseDtoStatus = typeof TrainingPlanResponseDtoStatus[keyof typeof TrainingPlanResponseDtoStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const TrainingPlanResponseDtoStatus = {
  DRAFT: 'DRAFT',
  ACTIVE: 'ACTIVE',
  ARCHIVED: 'ARCHIVED',
} as const;
