...
export type ClientTrainingPlansListMineSort = typeof ClientTrainingPlansListMineSort[keyof typeof ClientTrainingPlansListMineSort];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ClientTrainingPlansListMineSort = {
  name: 'name',
  createdAt: 'createdAt',
  updatedAt: 'updatedAt',
  startDate: 'startDate',
