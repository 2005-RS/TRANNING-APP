...
export type ClientProgressGetExercisePrescriptionType = typeof ClientProgressGetExercisePrescriptionType[keyof typeof ClientProgressGetExercisePrescriptionType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ClientProgressGetExercisePrescriptionType = {
  REPS: 'REPS',
  DURATION: 'DURATION',
} as const;
