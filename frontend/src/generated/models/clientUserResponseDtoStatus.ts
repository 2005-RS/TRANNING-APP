...
export type ClientUserResponseDtoStatus = typeof ClientUserResponseDtoStatus[keyof typeof ClientUserResponseDtoStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ClientUserResponseDtoStatus = {
  ACTIVE: 'ACTIVE',
  DISABLED: 'DISABLED',
} as const;
