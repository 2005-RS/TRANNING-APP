...
export type UpdateExerciseDtoPrimaryMuscleGroup = typeof UpdateExerciseDtoPrimaryMuscleGroup[keyof typeof UpdateExerciseDtoPrimaryMuscleGroup];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const UpdateExerciseDtoPrimaryMuscleGroup = {
  CHEST: 'CHEST',
  BACK: 'BACK',
  SHOULDERS: 'SHOULDERS',
  BICEPS: 'BICEPS',
