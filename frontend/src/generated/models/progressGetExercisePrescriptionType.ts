...
export type ProgressGetExercisePrescriptionType = typeof ProgressGetExercisePrescriptionType[keyof typeof ProgressGetExercisePrescriptionType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ProgressGetExercisePrescriptionType = {
  REPS: 'REPS',
  DURATION: 'DURATION',
} as const;
