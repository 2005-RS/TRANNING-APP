 ...
 * @nullable
 */
export type TrainerClientOverviewItemDtoLatestCheckInStatus = typeof TrainerClientOverviewItemDtoLatestCheckInStatus[keyof typeof TrainerClientOverviewItemDtoLatestCheckInStatus] | null;


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const TrainerClientOverviewItemDtoLatestCheckInStatus = {
  DRAFT: 'DRAFT',
  SUBMITTED: 'SUBMITTED',
  REVIEWED: 'REVIEWED',
} as const;
