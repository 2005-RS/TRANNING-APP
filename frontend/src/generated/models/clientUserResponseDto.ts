 ...
 */
import type { ClientUserResponseDtoRole } from './clientUserResponseDtoRole';
import type { ClientUserResponseDtoStatus } from './clientUserResponseDtoStatus';
...
export interface ClientUserResponseDto {
  ...
  firstName: string;
  lastName: string;
  role: ClientUserResponseDtoRole;
  status: ClientUserResponseDtoStatus;
}
