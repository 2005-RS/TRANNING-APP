...
export type TrainerUserResponseDtoStatus = typeof TrainerUserResponseDtoStatus[keyof typeof TrainerUserResponseDtoStatus];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const TrainerUserResponseDtoStatus = {
  ACTIVE: 'ACTIVE',
  DISABLED: 'DISABLED',
} as const;
