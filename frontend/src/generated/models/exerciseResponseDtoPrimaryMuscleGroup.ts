...
export type ExerciseResponseDtoPrimaryMuscleGroup = typeof ExerciseResponseDtoPrimaryMuscleGroup[keyof typeof ExerciseResponseDtoPrimaryMuscleGroup];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ExerciseResponseDtoPrimaryMuscleGroup = {
  CHEST: 'CHEST',
  BACK: 'BACK',
  SHOULDERS: 'SHOULDERS',
  BICEPS: 'BICEPS',
