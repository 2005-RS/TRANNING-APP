 ...
 */
import type { UpdateNutritionPlanStatusDtoStatus } from './updateNutritionPlanStatusDtoStatus';

export interface UpdateNutritionPlanStatusDto {
  ...
  status: UpdateNutritionPlanStatusDtoStatus;
}
