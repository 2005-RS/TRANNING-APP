...
export type DurationProgressSectionDtoPrescriptionType = typeof DurationProgressSectionDtoPrescriptionType[keyof typeof DurationProgressSectionDtoPrescriptionType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const DurationProgressSectionDtoPrescriptionType = {
  REPS: 'REPS',
  DURATION: 'DURATION',
} as const;
