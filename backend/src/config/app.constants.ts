...
export const AI_REQUEST_TIMEOUT_MS_DEFAULT = 30_000;
export const AI_MAX_HISTORY_MESSAGES_DEFAULT = 20;
export const AI_MAX_OUTPUT_TOKENS_DEFAULT = 800;
export const AI_RATE_LIMIT_PER_MINUTE_DEFAULT = 12;
export const AI_PUBLIC_RATE_LIMIT_PER_MINUTE_DEFAULT = 4;
export const AI_PUBLIC_DAILY_MESSAGE_LIMIT_DEFAULT = 300;
